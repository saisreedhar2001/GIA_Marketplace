  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      try {
        ...
        // User might be new, create profile
      ...
      <div className="w-full max-w-md px-4">
        <div className="card">
          <div className="text-center mb-8">
            <h1 className="font-serif text-3xl font-bold text-indigo mb-2">Welcome Back</h1>
            <p className="text-warm-gray">Sign in to your GIA account</p>
          </div>
